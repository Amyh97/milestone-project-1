...
My portfolio page did not change much druing the development process, the only change being I added soem screenshots (and place holder images for where I will eventually put screenshots of the backend development projects), to help add interest to the page and stop the text getting lost in the page.
![wireframe for Portfolio page](assets/images/portfolio-wireframe-sm.jpg)

Although I completly re-styled this page during the development of the project, it fundamentally stayed the same as the wireframe, the only difference between the form on the page now and the original on is to do with how each section was styled rather than the content, layout or positioning of the form.
...
-	To help me create the grid layout, header, and other elements such as the timeline, form and the accordion I used [Bootstrap 4](https://getbootstrap.com/).
-	I embellished the site using icons from [Fontawsome](https://fontawesome.com/), these were used in my header, footer and in the main section of my pages. I was able to use them to decorate my pages as well as use them as funtioning links.
...
-	I used [Material Design](https://material.io/) to help pick my colour scheme and find the hex codes for the colours that I used. Not only did it help me find the hex code for the main colour that I wanted, but it also gave the hex codes for a shade darker and lighter so that you could vary the website, while still having that consistency.
...
- As someone who would want to work with the developer I was able to click on links that took me to other porjects.
...
- As somone thinking about working with the developer, I was able to see where they are based, contact information and a bit abput them on the profile page. 
...
During the build of this website, I came across a few bugs that I needed to fix in order for it to work properly. For Example, I was finding that the CSS was not working on smaller viewports. What had happened 
was because I had opened a media query and in my editing, lost the curly brace that closed the query. 
...
-	To help create my navbar I have used Bootstrap code that I found through the W3Schools website [W3Schools](https://www.w3schools.com/bootstrap/tryit.asp?filename=trybs_navbar_collapse)
### Media
